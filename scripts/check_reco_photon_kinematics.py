...
bkg_pt_reco = ROOT.TH1D('pt_2f_bkg','pt_2f_bkg',100,0,20)
bkg_E_reco = ROOT.TH1D('E_2f_bkg','E_2f_bkg',100,0,20)
bkg_eta_reco = ROOT.TH1D('eta_2f_bkg','eta_2f_bkg',100,-5,5)
...
for key, delphes_file in delphes_file_list.items():
	...
	photon_E_reco[key].SetMaximum(0.25)
	...
	photon_eta_reco[key].SetMaximum(0.25)
	...
	photon_pt_reco[key].SetMaximum(0.25)
