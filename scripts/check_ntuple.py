...
file_mu_0p5_rec = ROOT.TFile("mu_0p5_mrec.root","RECREATE")
file_mu_5_rec = ROOT.TFile("mu_5_mrec.root","RECREATE")
file_mu_25_rec = ROOT.TFile("mu_25_mrec.root","RECREATE")
file_mu_2f_rec = ROOT.TFile("mu_2f_mrec.root","RECREATE")
file_mu_4f_rec = ROOT.TFile("mu_4f_mrec.root","RECREATE")
file_mu_0p5_rec.cd()
